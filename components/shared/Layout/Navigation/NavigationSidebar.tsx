...
import { Icon } from '@/root/components/shared/Icon/Test'
          ...
          <li className="relative text-muted">
            ...
            <motion.div initial="hidden" tabIndex={0} whileHover="hover">
              ...
              >
                ...
                <div>
                  <span className="block pb-2 text-2xl font-semibold leading-none border-b border-gray-600 text-highlight">
                    Categories
                  </span>
                ...
                <div>
                  <span className="block py-2 mt-8 text-2xl font-semibold border-b border-gray-600 text-highlight">
                    Subscribe
                  </span>
